        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            if (parser.eventType == XmlPullParser.START_TAG) {
                ...
                if (name == "chord") {
                    ...
                    type = Type.fromXmlValue(readText(parser))
                    ...
                    accidental = Accidental.fromXmlValue(readText(parser))
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            if (parser.eventType == XmlPullParser.START_TAG) {
                ...
                if (name == "step") {
                    ...
                    step = Step.fromXmlValue(readText(parser))
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            if (parser.eventType == XmlPullParser.START_TAG) {
                ...
                if (name == "sign") {
                    ...
                    sign = Sign.fromXmlValue(readText(parser))
